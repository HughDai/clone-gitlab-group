...
# ====================================================================
# manual
# Set an environment variable GITLAB_SESSION like "21ab2d2c3cbc4dfc33cafb14084450bf" which stored in the browsers cookies as a value to key "_gitlab_session"
